...
export default function TransactionsMigrationScript() {
    ...
    <div className="max-w-2xl mx-auto p-6 mt-16">
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">
          User Migration: Add pendingTransactionReviews Field
        </h2>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <li>For each user, counts transactions with status=“pending”</li>
            <li>Adds/updates the pendingTransactionReviews field</li>
