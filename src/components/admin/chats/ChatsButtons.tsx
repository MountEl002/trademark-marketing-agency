...
const ChatsButton: React.FC<ChatsButtonProps> = ({ name = "", onClick }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="horizontal-start group gap-3 pr-3 min-[550px]:pr-10 bg-green-500 hover:bg-green-700 text-sm min-[550px]:text-base text-white font-semibold rounded-md transition-all duration-500"
    >
