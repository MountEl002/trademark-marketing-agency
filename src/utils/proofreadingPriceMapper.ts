import { getAllLevels, getAllTimeframes, proofreadingTotalPrice } from '@/constants/proofreadingPricing';
...
export const proofreadingPriceMapper = (
  ...
  try {
    ...
    const price = proofreadingTotalPrice(
