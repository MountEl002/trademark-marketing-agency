import { getAllLevels, getAllTimeframes, rewritingTotalPrice } from '@/constants/rewritingPricing';
...
export const rewritingPriceMapper = (
  ...
  try {
    ...
    const price = rewritingTotalPrice(
